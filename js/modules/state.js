export const GROUP_COLORS = ['#3b82f6','#f59e0b','#10b981','#ef4444','#8b5cf6','#06b6d4','#22c55e','#f97316','#14b8a6','#e11d48','#0ea5e9','#65a30d','#a855f7','#0284c7','#d97706'];
...
export function createState() {
  return {
    ...
    groups: new Map(), features: [], minute: -1,
    mode: 'group', geomMode: 'detail', playTimer: null,
